...
AI(ChatGPT·Claude·v0·Lovable…)가 만든 웹사이트는 서로 닮는다: Inter 폰트, 보라-인디고 그라디언트, 아이콘 3카드, "미래를 만듭니다"류 헤드라인, 화면이 스스로를 설명하는 부제. 이 리포는 그 **AI스러움을 판별하고 교정해 실제 회사 웹사이트처럼 만드는** Claude Code 스킬 3종과 플레이북을 담는다.
...
- `plugins/real-company-website/skills/` — 스킬 3종(SKILL.md)
